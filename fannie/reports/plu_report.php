...
echo "<html><head><title>Department PLU List</title>
...
// ccm-rle 11-18-10 setup the query below to only show PLUs
...
$query = "SELECT p.upc AS UPC, 
    ...
    WHERE p.department IN ($deptArray) AND p.upc  < 99999
    $inUseQ";
    // echo $query;
$result = mysql_query($query);
$num = mysql_num_rows($result);

echo "<center><h1>PLU List</h1></center>";
...
echo '<form method = "post" action="plu_report.php" target="_blank">
