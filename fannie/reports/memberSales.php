...
if (isset($_POST['submit'])) {
	...
	echo "<html><head><title>Individual Member Sales Report</title>
...
// ccm-rle 9-28-09 - the department array shouldn't be hardcoded like this, modified it to match the 18 departments we have set-up at ccm, this will need to be modified to be auto-generated if a department add/remove interface is set-up in fannie 
	...
	echo "<center><h1>Individual Membership Sales Report</h1>\n
		<h2>Sales to Member $memberID  for $date1 thru $date2</h2></center>";
...
*/
		...
		echo "<table id=\"output2\" cellpadding=0 cellspacing=0 border=0 class=\"sortable-onload-8 rowstyle-alt colstyle-alt\">\n
	...
	if(isset($combinedupcReport)){
		// $query14 - Sales per PLU  -- ccm-rle added SUBSTR comparison to ignore the D appended on items given a percentage discount and count them on the report, otherwise they were ignored.
...
//		 echo $query14;
		...
		echo "<table id=\"output14\" cellpadding=0 cellspacing=0 border=0 class=\"sortable-onload-8 rowstyle-alt colstyle-alt\">\n
		  <caption>Department range: ".$arrayName.". Search yielded (".$num.") results. Generated on " . date('n/j/y \a\t h:i A') . "</caption>\n
		  <thead>\n
		    <tr>\n
		      <th class=\"sortable-numeric\">UPC</th>\n
	...
	if(isset($discountitemsReport)){
		// $query12 - Discounted Sales per PLU  -- ccm-rle added SUBSTR comparison to ignore the D appended on items given a percentage discount and count them on the report, otherwise they were ignored.
		$query12 = "SELECT DISTINCT 
			p.upc AS PLU,
			t.upc AS UPC,
			p.description AS Description,
			t.unitPrice AS Price,
...
//		 echo $query12;
		...
		echo "<table id=\"output12\" cellpadding=0 cellspacing=0 border=0 class=\"sortable-onload-12 rowstyle-alt colstyle-alt\">\n
		  <caption>Department range: ".$arrayName.". Search yielded (".$num.") results. Generated on " . date('n/j/y \a\t h:i A') . "</caption>\n
		  <thead>\n
		    <tr>\n
		      <th class=\"sortable-numeric\">UPC</th>\n
        ...
        if(isset($variablepricedReport)){
			...
			AND t.datetime >= '$date1a' AND t.datetime <= '$date2a' 
                ...
                echo "<table id=\"output1\" cellpadding=0 cellspacing=0 border=0 class=\"sortable-onload-8 rowstyle-alt colstyle-alt\">\n
                  <thead>\n
                    <tr>\n
                      <th class=\"sortable-numeric\">UPC</th>\n
                      <th class=\"sortable-text\">Description</th>\n
        ...
        if(isset($variablepricesalesReport)){
                ...
                echo "<table>
                  ...
                  <thead>\n
                    <tr>\n
                      <th class=\"sortable-text2\">Description</th>\n
                      <th class=\"sortable-currency2\">Price</th>\n
                      <th class=\"sortable2\">Date of Transaction</th>\n
                    </tr>\n
                  </thead>\n
                  <tbody>\n";
...
//                 echo $query4;
                ...
                echo "<table>
                  ...
                  <thead>\n
                    <tr>\n
                      <th class=\"sortable-text1\">Description</th>\n
                      <th class=\"sortable-currency1\">Price</th>\n
                      <th class=\"sortable-text99\">Quantity</th>\n
		      <th class=\"sortable1\">Date of Transaction</th>\n
                    </tr>\n
                  </thead>\n
                  <tbody>\n";
...
<form method="post" action="memberSales.php" target="_blank">		

<div id="box">
	<table border="0" cellspacing="3" cellpadding="3">
		<tr>
	    <th align="left"> <p><b>Enter Member #</b></p></th>
                <tr>
		<td><input type=text size=3 name=memberID></p>
		</td>
               </tr>
