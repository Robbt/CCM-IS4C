...
$opts['filters'] = "dept_no IN(".$_SESSION['deptArray'].")";
...
$opts['fdd']['dept_no'] = array(
  'name'     => 'Dept no',
  'select'   => 'T',
  'maxlen'   => 2,
  'sort'     => true
);
$opts['fdd']['dept_name'] = array(
  'name'     => 'Dept name',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['subdept_no'] = array(
  'name'     => 'Subdept no',
  'select'   => 'T',
  'maxlen'   => 4,
  'sort'     => true
);
$opts['fdd']['subdept_name'] = array(
  'name'     => 'Subdept name',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['item_count'] = array(
  'name'     => 'Item count',
  'select'   => 'T',
  'maxlen'   => 22,
  'sort'     => true
);
$opts['fdd']['item_total'] = array(
  'name'     => 'Item total',
  'select'   => 'T',
  'maxlen'   => 22,
  'sort'     => true
