...
/*******************************************************************************
    ...
    Copyright 2010 Calumet Natural Foods
...
<h3>This is the form to upload inventory from a CSV file consisting of the first column UPC and the second column the Number for the Inventory</h3>
<h4>Please Select Whether this File Contains a Front Stock or Back Stock Inventory</h4>
<form action="csvinventoryprocess.php" enctype="multipart/form-data" method="POST">

<input name="inventorytype" type="radio" value="frontstock">Front Stock </br>
<input name="inventorytype" type="radio" value="backstock">Back Stock </br>
