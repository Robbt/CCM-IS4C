...
*********************************************************************************/
//lane grants
//grant select,insert,delete,update on is4c_op.* to user@[server ip] identified by 'password'
//in our case
//grant select,insert,delete,update on is4c_op.* to is4clane@10.22.33.200;
//don't forget to flush privileges on lane database; 
//flush privileges;
...
//	$_SESSION["laneUser"] = "root";
	...
	if ($continue == 1) {
		...
		if ($server_num_rows > 1) $continue = 1;
...
function synctable($table,$serveruser,$serverpass='',$laneuser,$lanepass='',$opDB,$lane) {
