...
if ((!isset($_POST['submit'])) && (!isset($_POST['upc'])) && (!isset($_GET['upc']))) {
  ...
  <div id="box">
          <table border="0" cellspacing="3" cellpadding="3">
                ...
                <tr>
                     <td align="right"><p><b>Today Only</b></p></td>
                            <td>
                            <input type="checkbox" value="1" name="todayonly"> * requires UPC
                            </td>
                  </tr>
...
// ccm-rle 1-15-10 added WHERE SUBSTR(t.upc,2) = SUBSTR(p.upc,2) to below in order to try to include discounted items which are prefixed with a D via IS4C
		if (is_numeric($upc)) {
		  $dupc  =  "D" . (substr($upc, 1, 12));                
