...
$query = "SELECT p.upc AS UPC, 
	...
	p.wholesale_cost AS wholesale,
        p.brand AS brand,
	p.vendor AS vendor,
	p.frontstock AS frontstock,
	p.backstock AS backstock
...
echo "<table id=\"output\" cellpadding=0 cellspacing=0 border=0 class=\"sortable-onload-1 rowstyle-alt colstyle-alt\">\n
  ...
  <thead>\n
    <tr>\n
      ...
      <th class=\"sortable-numeric\">Front Stock</th>\n
      <th class=\"sortable-numeric\">Back Stock</th>\n	
    </tr>\n
  </thead>\n
  <tbody>\n";
