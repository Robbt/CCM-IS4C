...
if (isset($_POST['submit'])) {
	...
	echo "<html><head><title>Brand Sales Movement</title>
...
<form method="post" action="brandSales.php" target="_blank">		

<div id="box">
	<table border="0" cellspacing="3" cellpadding="3">
		<tr> 
            <th align="center"> <p><b>Select Brand(s).*</b></p></th>
		</tr>
		<tr valign=top>';

include('../src/brands.php');
