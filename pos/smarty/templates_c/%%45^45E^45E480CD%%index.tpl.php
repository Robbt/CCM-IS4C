<?php /* Smarty version 2.6.22, created on 2009-11-23 18:57:48
...
<link rel="stylesheet" href="../css/fannie.css" type="text/css">
<?php echo '
...
<?php if (isset ( $this->_tpl_vars['subdept'] )): ?>
<script type="text/javascript" language="JavaScript">
<?php echo $this->_tpl_vars['subdept']->printUpdateFunction($this->_tpl_vars['items']); ?>

</script>
<?php endif; ?>
<?php if (isset ( $this->_tpl_vars['jquery'] )): ?>
...
<script type="text/javascript">
        $(function(){
            $("#brandselect").autocomplete("/item/autocomplete.php");
        });
        $(function(){
            $("#vendorselect").autocomplete("/item/vendorautocomplete.php");
        });
...
<body <?php echo $this->_tpl_vars['javascriptonload']; ?>
 bgcolor="FFFFFF">
<div align="center">
   ...
   <table width="549" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
     ...
     <td colspan="2" bgcolor="FFFFFF">
      <table width="640" border="0" cellpadding="17" cellspacing="0">
       <tr>
