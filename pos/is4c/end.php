...
// ccm-rle 9-23-09 - Setting this to 0 did not stop the program from printing receipts. I will turn it back to a null value as it originally was set 
...
function cleartemptrans() {
	...
	if($_SESSION["msg"] == 2) {
		$_SESSION["msg"] = 99;
//		truncateTempTables();
// ccm-rle added previous line and commented out this line to wipe suspended transactions vs. marking them as cancelled, commented out previous at it was wiping all cancelled transactions vs. saving them to database
