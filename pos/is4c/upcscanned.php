...
// ccm-rle 9-23-09 - below is where the hard limit is set for single item discounts - we want to change this to 100% from the current limit of less than 65 percent to allow more flexibility for cashiers. 
...
// added this to calculate the discount properly on hobart scale items that start with the 2 prefix
